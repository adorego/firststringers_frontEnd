  ...
  return (
    <article className="mx-auto max-w-3xl px-5 py-8 leading-relaxed text-gray-900 font-sans">
      ...
      <section id="information-we-collect" className="mt-10">
        ...
        <h3 className="mt-8 text-xl md:text-2xl font-semibold">Legitimate Reasons for Processing Your Personal Information</h3>
        <p className="mt-4">
      ...
      <section id="collection-and-use" className="mt-10">
        <h2 className="text-2xl md:text-3xl font-semibold tracking-tight">Collection and Use of Information</h2>
        <p className="mt-4">We may collect personal information from you when you do any of the following on our website:</p>
        <ul className="mt-4 list-disc list-inside space-y-2">
      ...
      <section id="security" className="mt-10">
        <h2 className="text-2xl md:text-3xl font-semibold tracking-tight">Security of Your Personal Information</h2>
        <p className="mt-4">
      ...
      <section id="retention" className="mt-10">
        <h2 className="text-2xl md:text-3xl font-semibold tracking-tight">How Long We Keep Your Personal Information</h2>
        <p className="mt-4">
      ...
      <section id="children" className="mt-10">
        <h2 className="text-2xl md:text-3xl font-semibold tracking-tight">Children’s Privacy</h2>
        <p className="mt-4">
      ...
      <section id="disclosure" className="mt-10">
        <h2 className="text-2xl md:text-3xl font-semibold tracking-tight">Disclosure of Personal Information to Third Parties</h2>
        <p className="mt-4">We may disclose personal information to:</p>
        <ul className="mt-4 list-disc list-inside space-y-2">
          <li>a parent, subsidiary or affiliate of our company</li>
          <li>
            third-party service providers for the purpose of enabling them to provide their services, including
            (without limitation) IT service providers, data storage, hosting and server providers, analytics,
            error loggers, debt collectors, maintenance or problem-solving providers, marketing providers,
        ...
        <h3 className="mt-8 text-xl md:text-2xl font-semibold">Third parties we currently use include:</h3>
        <ul className="mt-4 list-disc list-inside space-y-2">
          <li>Google Analytics</li>
          <li>First Stringers Content Delivery</li>
        </ul>
      </section>

      {/* Rights & Control */}
      <section id="rights" className="mt-10">
        <h2 className="text-2xl md:text-3xl font-semibold tracking-tight">Your Rights and Controlling Your Personal Information</h2>
        <p className="mt-4">
          <span className="font-medium">Your choice:</span> By providing personal information to us, you understand we will collect, hold,
        ...
        <p className="mt-4">
          <span className="font-medium">Information from third parties:</span> If we receive personal information about you from a third
        ...
        <p className="mt-4">
          <span className="font-medium">Marketing permission:</span> If you have previously agreed to us using your personal information for
          direct marketing purposes, you may change your mind at any time by contacting us using the details below.
        </p>
        <p className="mt-4">
          <span className="font-medium">Access:</span> You may request details of the personal information that we hold about you.
        </p>
        <p className="mt-4">
          <span className="font-medium">Correction:</span> If you believe that any information we hold about you is inaccurate, out of date,
          incomplete, irrelevant, or misleading, please contact us using the details provided in this privacy
        ...
        <p className="mt-4">
          <span className="font-medium">Non-discrimination:</span> We will not discriminate against you for exercising any of your rights over
          your personal information. Unless your personal information is required to provide you with a particular
          service or offer (for example providing user support), we will not deny you goods or services and/or
        ...
        <p className="mt-4">
          <span className="font-medium">Notification of data breaches:</span> We will comply with laws applicable to us in respect of any data
          breach.
        </p>
        <p className="mt-4">
          <span className="font-medium">Complaints:</span> If you believe that we have breached a relevant data protection law and wish to make a
          complaint, please contact us using the details below and provide us with full details of the alleged
      ...
      {/* Business Transfers */}
      <section id="business-transfers" className="mt-10">
        <h2 className="text-2xl md:text-3xl font-semibold tracking-tight">Business Transfers</h2>
        <p className="mt-4">
      ...
      <section id="limits" className="mt-10">
        <h2 className="text-2xl md:text-3xl font-semibold tracking-tight">Limits of Our Policy</h2>
        <p className="mt-4">
      ...
      <section id="changes" className="mt-10">
        <h2 className="text-2xl md:text-3xl font-semibold tracking-tight">Changes to This Policy</h2>
        <p className="mt-4">
      ...
      {/* U.S. States Privacy Law Compliance */}
      <section id="us-states" className="mt-10">
        ...
        <h3 className="mt-8 text-xl md:text-2xl font-semibold">California Privacy Laws - CPPA</h3>
        <p className="mt-4">
          ...
          incentive we offer will reasonably relate to the value of your personal information, and we will provide
          written terms that describe clearly the nature of such an offer. Participation in a financial incentive
        ...
        <p className="mt-4">
          ...
          using the details provided in this privacy policy with “Request for California privacy information” in
          the subject line. You may make this type of request once every calendar year. We will email you a list of
          categories of personal information we revealed to other organisations for their marketing purposes in the
          last calendar year, along with their names and addresses. Not all personal information shared in this way
          is covered by Section 1798.83 of the California Civil Code.
        </p>

        <h3 className="mt-8 text-xl md:text-2xl font-semibold">California Notice of Collection</h3>
        <p className="mt-4">
          In the past 12 months, we have collected the following categories of personal information enumerated in
          the CCPA:
        </p>
        <ul className="mt-4 list-disc list-inside space-y-2">
          <li>
            Identifiers, such as name, email address, phone number, account name, IP address, and an ID or number
        ...
        <p className="mt-4">
          For more information on information we collect, including the sources we receive information from, review
          the “Information We Collect” section. We collect and use these categories of personal information for the
          business purposes described in the “Collection and Use of Information” section, including to provide and
          manage our Service.
        </p>

        <h3 className="mt-8 text-xl md:text-2xl font-semibold">Right to Know and Delete</h3>
        <p className="mt-4">You have rights to delete your personal information we collected and know certain information about our data practices in the preceding 12 months. In particular, you have the right to request the following from us:</p>
        <ul className="mt-4 list-disc list-inside space-y-2">
        ...
        <p className="mt-4">To exercise any of these rights, please contact us using the details provided in this privacy policy.</p>

        <h3 className="mt-8 text-xl md:text-2xl font-semibold">Shine the Light</h3>
        <p className="mt-4">
        ...
        <p className="mt-4">
          To receive this information, send us a request using the contact details provided in this privacy policy.
          Requests must include “Privacy Rights Request” in the first line of the description and include your
